...
def uploadVideo(EXPORTED_VIDEO_PATH, FILE_NAME, FILE_EXTENSION):
    ...
    button = driver.find_element(By.XPATH, "//button[@class='ytcp-button-shape-impl ytcp-button-shape-impl--filled ytcp-button-shape-impl--mono ytcp-button-shape-impl--size-m' and @aria-label='שמירה']")
    button.click()
